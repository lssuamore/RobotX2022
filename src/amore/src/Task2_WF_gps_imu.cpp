...
int main(int argc, char **argv)
{
	...
	ros::Subscriber WF_Converter_sub = nh6.subscribe("WF_Converter_status", 1, WF_conv_status);            // subscriber for whether or not goal waypoints have been converted yet
