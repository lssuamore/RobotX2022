...
int main(int argc, char **argv)
{
	...
	ros::Subscriber geonav_odom_sub = nh4.subscribe("geonav_odom", 100, NED_Func);
	...
	nav_odom_pub = nh7.advertise<nav_msgs::Odometry>("nav_odom", 100); 																// USV state publisher, this sends the current state to nav_odom, so geonav_transform package can publish the ENU conversion to geonav_odom
