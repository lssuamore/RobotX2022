...
void gazebo::GUITaskWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        GUITaskWidget *_t = static_cast<GUITaskWidget *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (GUITaskWidget::*_t)(QString );
        ...
        {
            typedef void (GUITaskWidget::*_t)(QPixmap );
...
const QMetaObject gazebo::GUITaskWidget::staticMetaObject = {
    { &GUIPlugin::staticMetaObject, qt_meta_stringdata_gazebo__GUITaskWidget.data,
      qt_meta_data_gazebo__GUITaskWidget,  qt_static_metacall, nullptr, nullptr}
};
