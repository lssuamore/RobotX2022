...
echo_and_run cd "/home/amore/RobotX2022/src/sensors/rosserial/rosserial_arduino"
...
echo_and_run /usr/bin/env \
    ...
    "/home/amore/RobotX2022/src/sensors/rosserial/rosserial_arduino/setup.py" \
     \
    build --build-base "/home/amore/RobotX2022/build/sensors/rosserial/rosserial_arduino" \
    install \
    --root="${DESTDIR-/}" \
