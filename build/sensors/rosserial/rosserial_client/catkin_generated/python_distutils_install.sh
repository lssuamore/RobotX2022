...
echo_and_run cd "/home/amore/RobotX2022/src/sensors/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/home/amore/RobotX2022/src/sensors/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/amore/RobotX2022/build/sensors/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
