...
echo_and_run cd "/home/taylor/RobotX2022/src/sensors/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python3" \
    "/home/taylor/RobotX2022/src/sensors/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/taylor/RobotX2022/build/sensors/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
