...
set(MSG_I_FLAGS "-Iamore:/home/amore/RobotX2022/src/amore/msg;-Igeometry_msgs:/opt/ros/melodic/share/geometry_msgs/cmake/../msg;-Istd_msgs:/opt/ros/melodic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/amore/RobotX2022/src/amore/msg/NED_waypoints.msg" NAME_WE)
add_custom_target(_amore_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "amore" "/home/amore/RobotX2022/src/amore/msg/NED_waypoints.msg" "geometry_msgs/Point"
)

get_filename_component(_filename "/home/amore/RobotX2022/src/amore/msg/usv_pose_msg.msg" NAME_WE)
add_custom_target(_amore_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "amore" "/home/amore/RobotX2022/src/amore/msg/usv_pose_msg.msg" "std_msgs/Float64:geometry_msgs/Point:std_msgs/Header"
)

get_filename_component(_filename "/home/amore/RobotX2022/src/amore/msg/state_msg.msg" NAME_WE)
add_custom_target(_amore_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "amore" "/home/amore/RobotX2022/src/amore/msg/state_msg.msg" "std_msgs/Int32:std_msgs/Header"
)
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/amore)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/amore\")")
  # install generated code
  install(
