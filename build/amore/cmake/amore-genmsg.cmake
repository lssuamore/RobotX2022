...
add_custom_target(_amore_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "amore" "/home/taylor/RobotX2022/src/amore/msg/usv_pose_msg.msg" "std_msgs/Float64:geometry_msgs/Point:std_msgs/Header"
)

get_filename_component(_filename "/home/taylor/RobotX2022/src/amore/msg/state_msg.msg" NAME_WE)
add_custom_target(_amore_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "amore" "/home/taylor/RobotX2022/src/amore/msg/state_msg.msg" "std_msgs/Int32:std_msgs/Header"
)
