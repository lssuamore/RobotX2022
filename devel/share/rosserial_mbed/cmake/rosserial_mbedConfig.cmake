...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_mbed_SOURCE_PREFIX /home/amore/RobotX2022/src/sensors/rosserial/rosserial_mbed)
  set(rosserial_mbed_DEVEL_PREFIX /home/amore/RobotX2022/devel)
  ...
  set(rosserial_mbed_INSTALL_PREFIX /home/amore/RobotX2022/install)
...
if(NOT "/home/amore/RobotX2022/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rosserial_mbed' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amore/RobotX2022/src/sensors/rosserial/rosserial_mbed/${idir}'.  ${_report}")
    endif()
