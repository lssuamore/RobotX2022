...
(defsystem "ublox_msgs-msg"
  ...
  :components ((:file "_package")
    ...
    (:file "NavHPPOSECEF" :depends-on ("_package_NavHPPOSECEF"))
    (:file "_package_NavHPPOSECEF" :depends-on ("_package"))
    (:file "NavHPPOSLLH" :depends-on ("_package_NavHPPOSLLH"))
    (:file "_package_NavHPPOSLLH" :depends-on ("_package"))
