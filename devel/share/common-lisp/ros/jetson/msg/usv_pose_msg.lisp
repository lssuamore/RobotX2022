...
(cl:defmethod cl:initialize-instance :after ((m <usv_pose_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'usv_pose_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name jetson-msg:<usv_pose_msg> is deprecated: use jetson-msg:usv_pose_msg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <usv_pose_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetson-msg:header-val is deprecated.  Use jetson-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <usv_pose_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetson-msg:position-val is deprecated.  Use jetson-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'psi-val :lambda-list '(m))
(cl:defmethod psi-val ((m <usv_pose_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetson-msg:psi-val is deprecated.  Use jetson-msg:psi instead.")
  (psi m))

(cl:ensure-generic-function 'latitude-val :lambda-list '(m))
(cl:defmethod latitude-val ((m <usv_pose_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetson-msg:latitude-val is deprecated.  Use jetson-msg:latitude instead.")
  (latitude m))

(cl:ensure-generic-function 'longitude-val :lambda-list '(m))
(cl:defmethod longitude-val ((m <usv_pose_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader jetson-msg:longitude-val is deprecated.  Use jetson-msg:longitude instead.")
  (longitude m))
