// Generated by gencpp from file ublox_msgs/NavRELPOSNED9.msg
// DO NOT EDIT!


#ifndef UBLOX_MSGS_MESSAGE_NAVRELPOSNED9_H
#define UBLOX_MSGS_MESSAGE_NAVRELPOSNED9_H
...
{
  typedef NavRELPOSNED9_<ContainerAllocator> Type;
  ...
  NavRELPOSNED9_(const ContainerAllocator& _alloc)
    : version(0)
    , reserved1(0)
    , refStationId(0)
    , iTow(0)
  ...
  _accHeading_type accHeading;
   ...
   typedef boost::array<uint8_t, 4>  _reserved3_type;
...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(FLAGS_REL_POS_HEAD_VALID)
  #undef FLAGS_REL_POS_HEAD_VALID
#endif
#if defined(_WIN32) && defined(FLAGS_REL_POS_NORM)
  #undef FLAGS_REL_POS_NORM
#endif
  ...
  enum {
    ...
    FLAGS_REL_POS_HEAD_VALID = 256u,
    FLAGS_REL_POS_NORM = 512u,
  };


  typedef boost::shared_ptr< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> const> ConstPtr;

}; // struct NavRELPOSNED9_

typedef ::ublox_msgs::NavRELPOSNED9_<std::allocator<void> > NavRELPOSNED9;

typedef boost::shared_ptr< ::ublox_msgs::NavRELPOSNED9 > NavRELPOSNED9Ptr;
typedef boost::shared_ptr< ::ublox_msgs::NavRELPOSNED9 const> NavRELPOSNED9ConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator1> & lhs, const ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsMessage< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x6dedd6e7018b83e2ULL;
  static const uint64_t static_value2 = 0xb0ae65fb6873207eULL;
};

template<class ContainerAllocator>
struct DataType< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ublox_msgs/NavRELPOSNED9";
  }
...
template<class ContainerAllocator>
struct Definition< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ublox_msgs::NavRELPOSNED9_<ContainerAllocator>& v)
  {
    s << indent << "version: ";
    ...
    Printer<int8_t>::stream(s, indent + "  ", v.relPosHPLength);
    s << indent << "accN: ";
...
#endif // UBLOX_MSGS_MESSAGE_NAVRELPOSNED9_H
